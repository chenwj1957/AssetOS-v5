...
from src_backend.core.types import ArtifactResult
from src_backend.memory.files.writer import FileWriter
from src_backend.tools.build_docx.builder import DocxBuilder
from src_backend.tools.build_docx.mappers.invoice_to_docx_spec import invoice_to_docx_spec
from src_backend.tools.build_docx.schema.docx_spec import DocxSpec
from src_backend.tools.build_docx.validators import (
    validate_docx_spec,
